...
Profil Saya pada `/nexus/profil` menjadi satu-satunya permukaan profil pribadi untuk setiap akun dan dibuka dari menu pengguna di kanan atas. Akun yang terhubung ke anggota menyunting informasi pribadinya langsung pada rekam anggota kanonis, sedangkan akun non-anggota memakai informasi pribadi miliknya sendiri; kartu keanggotaan, keahlian, dan identitas akademik hanya muncul untuk akun yang memang terhubung. Email masuk, peran, status akun, dan hubungan anggota tetap baca-saja karena dikelola melalui Administrasi. Halaman ini tidak menampilkan MFA, daftar perangkat, atau penghapusan akun mandiri, dan menyatakan apa adanya bahwa penggantian kata sandi belum dapat dilakukan dari ruang kerja.
