...
Identitas anggota awal memakai satu daftar ID eksplisit yang tidak berubah ketika gelar atau nama tampilan diperbarui. Hubungan akun diproyeksikan tanpa memasukkan akun ke sumber profil anggota dan membedakan tidak ada hubungan, satu hubungan yang sah, serta catatan yang berkonflik. Fixture akun operasional memakai identitas netral dan tidak mengarang riwayat akses privat untuk nama anggota publik. Administrasi juga membedakan role yang dikenal, belum ditetapkan, dan tidak lagi dikenali; tautan akun atau anggota yang tidak valid berhenti pada keadaan tidak ditemukan sebelum pengguna memilih konteks baru.
