...
| Halaman Monitoring KM BHT Nexus | Tersedia dan responsif; Ringkasan memakai pemilih periode evaluasi dan pemilih domain yang dapat digeser, lalu menampilkan kartu ringkasan, capaian per domain, kemajuan indikator, dan pembaruan data resmi terbaru tanpa berpindah halaman. Kategori Riset sudah punya halaman pemantauan sendiri sampai rincian KM-9 hingga KM-18; domain lain menampilkan keadaan sedang disiapkan, bukan capaian nol. Target dan keterangan indikator berasal dari workbook KM 2026, sedangkan realisasi dihitung dari rekam data resmi yang berkait indikator dan dapat ditelusuri sampai daftar rekam pembentuknya. Susunan halaman Riset masih dapat berubah |
