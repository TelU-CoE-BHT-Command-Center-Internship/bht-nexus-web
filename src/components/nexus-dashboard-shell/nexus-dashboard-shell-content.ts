...
const navigationDefinitions: NavigationDefinition[] = [
  ...
  },
  {
    ...
    label: { en: "Ask Documents", id: "Tanya Dokumen" },
  ...
  },
  {
    group: "scraper",
    href: {
      en: "/en/nexus/researcher-search",
      id: "/nexus/pencarian-peneliti",
    },
    icon: "search",
    id: "researcher-search",
    label: { en: "Researcher Search", id: "Pencarian Peneliti" },
    permission: "scraper:read",
  },
  {
    group: "scraper",
    href: { en: "/en/nexus/job-status", id: "/nexus/status-job" },
    icon: "jobs",
    id: "job-status",
    label: { en: "Job Status", id: "Status Job" },
    permission: "jobs:read",
  },
  {
    group: "scraper",
    href: {
      en: "/en/nexus/collection-results",
      id: "/nexus/hasil-pengumpulan",
    },
    icon: "candidates",
    id: "collection-results",
    label: { en: "Collection Results", id: "Hasil Pengumpulan" },
...
const previewSession = {
  availableRoutes: new Set([
    ...
    "/nexus/dokumen",
    "/nexus/ekstraksi",
    "/nexus/hasil-pengumpulan",
    "/nexus/pencarian-peneliti",
    "/nexus/status-job",
    "/nexus/tanya-dokumen",
    "/en/nexus/ask-documents",
    "/en/nexus/collection-results",
    "/en/nexus/documents",
    "/en/nexus/extraction",
    "/en/nexus/job-status",
    "/en/nexus/researcher-search",
  ]),
