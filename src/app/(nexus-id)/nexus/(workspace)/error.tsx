...
export default function WorkspaceErrorBoundary({
  ...
  return (
    <NexusWorkspaceError
      description="Ruang kerja tidak dapat dimuat saat ini. Data resmi tidak berubah. Coba muat kembali bagian ini."
      errorReference={error.digest}
      referenceLabel="Referensi kendala"
      retry={retry}
      retryLabel="Coba lagi"
      title="Terjadi kendala saat memuat ruang kerja"
    />
  );
}
