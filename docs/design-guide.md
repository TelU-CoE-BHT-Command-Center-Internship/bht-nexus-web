...
Identitas pengguna di kanan atas terdiri atas foto, satu nama, dan tanda buka menu. Menunya berisi nama lengkap, email masuk, tautan Profil Saya, lalu Keluar yang dipisahkan garis. Menu ini hanya memuat tindakan yang benar-benar dimiliki produk; entri bantuan, penagihan, atau preferensi tampilan tidak ditambahkan hanya karena ada pada template rujukan. Profil Saya tidak menjadi butir navigasi utama karena ia merupakan konteks personal, bukan modul ruang kerja.
