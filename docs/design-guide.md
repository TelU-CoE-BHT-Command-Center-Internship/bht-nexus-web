...
Monitoring KM mempunyai tiga tingkat: Semua Domain, ikhtisar satu domain, lalu rincian satu indikator. Ketiganya memakai kerangka halaman yang sama—judul, pemilih periode, pemilih domain—sehingga berpindah domain terasa seperti mengganti isi, bukan berpindah aplikasi.
...
Rincian satu indikator dibuka dengan jejak halaman di kiri dan perpindahan ke indikator sebelumnya atau berikutnya di kanan, lalu empat kartu metrik, sebaran triwulan, cara perhitungan, dan daftar rekam pembentuk. Urutan itu menjawab pertanyaan pembaca menurut urutan munculnya: berapa angkanya, kapan terjadinya, bagaimana dihitungnya, dan rekam mana yang membentuknya. Definisi indikator beserta persyaratan evidennya diletakkan pada bagian yang dapat dibuka karena keduanya dibaca sekali saat memastikan aturan, bukan setiap kali halaman dibuka.

Daftar rekam pembentuk memakai tabel rekam resmi bersama, lengkap dengan kolom Aksi seperti rumah Data Resmi lainnya. Lebar kolomnya ditulis di halaman ini sendiri dan kolom judul sengaja dibiarkan tanpa lebar supaya ia menyerap sisa ruang; tanpa itu `table-layout: fixed` membagi semua kolom sama rata dan kolom terakhir menyisakan ruang kosong yang lebar.

Rincian sebuah rekam memakai kerangka drawer bersama, sama seperti rumah Data Resmi: ringkasan atas, seksi bernomor, kartu jejak sumber, lalu keputusan tinjauan. Bidang metadata yang ditampilkan mengikuti rumah data asalnya karena bidang yang berarti memang berbeda—Publikasi menyebut penulis, wadah terbit, dan kuartil, sedangkan Kekayaan Intelektual menyebut jenis perlindungan, pencipta, dan nomor pencatatan. Drawer ini tidak memakai penanda langkah: penanda itu menggambarkan siklus hidup rekam, dan memasangnya di panel yang hanya dibaca membuat halaman terbaca seolah ada proses yang belum selesai.
...
Cincin komposisi mempunyai dua bentuk. Pada kartu separuh lebar, legenda melebar mengikuti kartu dan nilainya dirapatkan ke tepi kanan. Pada kartu selebar penuh, cincin beserta legendanya berdiri sebagai satu blok di tengah dan kolom nilai di tepi kanan ditiadakan: pada lebar itu legenda tidak lagi melebar, sehingga menuliskan angka yang sama dua kali hanya mengulang informasi dan meninggalkan jarak panjang menuju tepi. Angka aslinya tetap disebut pada keterangan tiap baris legenda, jadi kartunya tetap lengkap tanpa warna.

Kartu yang berdampingan pada satu baris analitik selalu setinggi barisnya, bukan setinggi isinya masing-masing. Sebaran triwulan tidak selalu dapat dibentuk, sehingga tanpa aturan itu kartu kiri menyusut dan menyisakan ruang kosong di sebelah kartu kanan yang lebih panjang. Baris penutup tiap kartu—rincian per triwulan dan kalimat capaian—menempel ke bawah, sedangkan grafiknya tetap setinggi aslinya supaya tidak teregang. Baris yang hanya berisi satu kartu memakai kisi yang membiarkan kartu itu memenuhi lebar penuh, bukan menyisakan separuh baris kosong.
