...
| State akun lintas halaman | `NexusAccountSessionProvider` | satu sumber akun, role, status, dan hubungan anggota untuk Administrasi serta Anggota selama layout workspace aktif |
