...
| Monitoring KM | `getNexusMonitoringRecords`, `measureIndicator`, `summarizeRiset`, dan `getNexusMonitoringCategories` | membaca ulang rumah Data Resmi yang sama tanpa menyalinnya, menghitung realisasi indikator Riset dari kaitan KM eksplisit, menyusun sebaran per rumpun data, dan menyiapkan data pembentuk realisasi |
