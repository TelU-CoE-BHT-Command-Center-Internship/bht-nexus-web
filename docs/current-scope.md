...
- `/nexus/monitoring/riset/km-9` sampai `km-18` tetap menjadi alamat yang sah dan tetap membawa identitas indikator yang tepat. Untuk sementara alamat itu menampilkan keadaan sedang disiapkan beserta jalan kembali ke Riset; penyajian rinciannya dirancang ulang pada paket kerja tersendiri. Alamat indikator di luar daftar tersebut tetap menampilkan keadaan tidak ditemukan, bukan keadaan sedang disiapkan dan bukan indikator pertama.
- Angka target, realisasi, capaian, dan status setiap indikator tetap tersedia pada Capaian Indikator Riset di ikhtisar Riset selama halaman rinciannya disiapkan.
...
- Identitas dan label KM-1 sampai KM-46 berada pada satu kamus yang diturunkan dari worksheet `List KM` workbook stakeholder. Rekam hanya merujuk indikator dari kamus tersebut dan dapat memiliki nol, satu, atau beberapa kaitan tanpa menggandakan data. Definisi, cara perhitungan, satuan, periode, target, dan realisasi dimodelkan pada Monitoring KM dan sudah dihitung untuk kategori Riset (KM-9 sampai KM-18); angkanya dibaca melalui ikhtisar Riset. Kandidat yang klasifikasinya belum didukung bukti ditampilkan sebagai belum dikaitkan dengan indikator evaluasi.
...
| `/nexus/monitoring/riset/[indikator]` | Alamat KM-9 sampai KM-18; rinciannya sedang disiapkan |
